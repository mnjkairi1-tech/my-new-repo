...
export const aiVoiceAudioTools: Tool[] = [
    { name: 'ElevenLabs', description: 'Realistic text-to-speech and voice cloning.', url: 'https://elevenlabs.io/', image: 'https://www.google.com/s2/favicons?sz=128&domain=elevenlabs.io', dataAiHint: 'ai voice', pricing: 'Freemium' },
    ...
    { name: 'Descript Overdub', description: 'Create a text-to-speech model of your voice.', url: 'https://www.descript.com/overdub', image: 'https://www.google.com/s2/favicons?sz=128&domain=descript.com', dataAiHint: 'ai voice model', pricing: 'Freemium' },
    ...
    { name: 'Cleanvoice AI', description: 'Automatically edit your podcast episodes.', url: 'https://cleanvoice.ai/', image: 'https://www.google.com/s2/favicons?sz=128&domain=cleanvoice.ai', dataAiHint: 'podcast editing', pricing: 'Paid' },
    { name: 'Auphonic', description: 'Automatic audio post production web service.', url: 'https://auphonic.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=auphonic.com', dataAiHint: 'audio post production', pricing: 'Freemium' },
