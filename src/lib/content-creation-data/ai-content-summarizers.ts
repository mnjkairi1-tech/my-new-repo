...
export const aiContentSummarizersTools: Tool[] = [
    { name: 'Scholarcy', description: 'AI-powered article summarizer.', url: 'https://www.scholarcy.com/', image: 'https://picsum.photos/seed/scholarcy-sum/600/400', dataAiHint: 'article summarizer', pricing: 'Freemium' },
    { name: 'QuillBot', description: 'Paraphrasing and summarizing tool.', url: 'https://quillbot.com/', image: 'https://picsum.photos/seed/quillbot-sum/600/400', dataAiHint: 'text summarizer', pricing: 'Freemium' },
    { name: 'SMMRY', description: 'Summarize articles, text, and websites.', url: 'https://smmry.com/', image: 'https://picsum.photos/seed/smmry-sum/600/400', dataAiHint: 'web summarizer', pricing: 'Free' },
    { name: 'Humata AI', description: 'Your AI for files. Ask questions, get answers, and summarize.', url: 'https://www.humata.ai/', image: 'https://picsum.photos/seed/humataai-sum/600/400', dataAiHint: 'document ai', pricing: 'Freemium' },
