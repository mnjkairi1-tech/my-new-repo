...
export const aiConversationalAIPlatformsTools: Tool[] = [
    ...
    { name: 'Haptik', description: 'Conversational AI for businesses.', url: 'https://haptik.ai/', image: 'https://www.google.com/s2/favicons?sz=128&domain=haptik.ai', dataAiHint: 'business ai', pricing: 'Paid' },
    { name: 'Cognigy', description: 'Enterprise conversational AI.', url: 'https://www.cognigy.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=cognigy.com', dataAiHint: 'enterprise conversation', pricing: 'Paid' },
    { name: 'Verloop.io', description: 'Conversational AI platform for customer support.', url: 'https://verloop.io/', image: 'https://www.google.com/s2/favicons?sz=128&domain=verloop.io', dataAiHint: 'customer support', pricing: 'Paid' },
    { name: 'Yellow.ai', description: 'Total Experience Automation Platform.', url: 'https://yellow.ai/', image: 'https://www.google.com/s2/favicons?sz=128&domain=yellow.ai', dataAiHint: 'experience automation', pricing: 'Paid' },
    { name: 'IBM Watson Assistant', description: 'Build powerful AI assistants for any channel.', url: 'https://www.ibm.com/products/watson-assistant', image: 'https://www.google.com/s2/favicons?sz=128&domain=ibm.com', dataAiHint: 'ibm ai', pricing: 'Freemium' },
];
