...
export const aiTaskAutomationAssistantsTools: Tool[] = [
    ...
    { name: 'IFTTT', description: 'If This Then That. Simple app connections.', url: 'https://ifttt.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=ifttt.com', dataAiHint: 'applets', pricing: 'Freemium' },
    ...
    { name: 'Bardeen', description: 'AI meets automations. Automate manual workflows.', url: 'https://www.bardeen.ai/', image: 'https://www.google.com/s2/favicons?sz=128&domain=bardeen.ai', dataAiHint: 'browser automation', pricing: 'Freemium' },
    { name: 'Microsoft Power Automate', description: 'Automate tasks and processes.', url: 'https://powerautomate.microsoft.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=powerautomate.microsoft.com', dataAiHint: 'process automation', pricing: 'Freemium' },
