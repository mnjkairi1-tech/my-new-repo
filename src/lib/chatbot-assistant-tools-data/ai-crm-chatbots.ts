...
export const aiCrmChatbotsTools: Tool[] = [
    { name: 'HubSpot Chatbot Builder', description: 'Free chatbot builder integrated with your CRM.', url: 'https://www.hubspot.com/products/marketing/chatbot-builder', image: 'https://www.google.com/s2/favicons?sz=128&domain=hubspot.com', dataAiHint: 'crm chatbot', pricing: 'Free' },
    { name: 'Zendesk', description: 'Integrate AI chatbots with your customer service CRM.', url: 'https://www.zendesk.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=zendesk.com', dataAiHint: 'customer service', pricing: 'Paid' },
    { name: 'Salesforce Einstein', description: 'AI for the world\'s #1 CRM.', url: 'https://www.salesforce.com/products/einstein/', image: 'https://www.google.com/s2/favicons?sz=128&domain=salesforce.com', dataAiHint: 'sales ai', pricing: 'Paid' },
    { name: 'Intercom', description: 'Conversational support platform with CRM capabilities.', url: 'https://www.intercom.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=intercom.com', dataAiHint: 'conversational support', pricing: 'Paid' },
