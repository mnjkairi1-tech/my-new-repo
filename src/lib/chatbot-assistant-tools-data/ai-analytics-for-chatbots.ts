...
export const aiAnalyticsForChatbotsTools: Tool[] = [
    ...
    { name: 'Rasa X', description: 'A toolset to learn from real conversations and improve your AI assistant.', url: 'https://rasa.com/docs/rasa-x/', image: 'https://www.google.com/s2/favicons?sz=128&domain=rasa.com', dataAiHint: 'rasa toolset', pricing: 'Free' },
    { name: 'Azure Bot Analytics', description: 'Analytics for bots built with Microsoft Bot Framework.', url: 'https://docs.microsoft.com/en-us/azure/bot-service/bot-builder-telemetry-analytics', image: 'https://www.google.com/s2/favicons?sz=128&domain=microsoft.com', dataAiHint: 'azure analytics', pricing: 'Paid' },
    { name: 'Amazon Lex Analytics', description: 'Monitor and analyze your Lex bots.', url: 'https://aws.amazon.com/lex/', image: 'https://www.google.com/s2/favicons?sz=128&domain=aws.amazon.com', dataAiHint: 'aws lex', pricing: 'Paid' },
