...
export const aiEcommerceChatbotsTools: Tool[] = [
    ...
    { name: 'Tidio', description: 'Engage e-commerce customers with live chat and chatbots.', url: 'https://www.tidio.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=tidio.com', dataAiHint: 'live chat', pricing: 'Freemium' },
