...
export const aiInternalTeamAssistantsTools: Tool[] = [
    ...
    { name: 'Clevy', description: 'Build chatbots for internal use.', url: 'https://www.clevy.io/', image: 'https://www.google.com/s2/favicons?sz=128&domain=clevy.io', dataAiHint: 'internal chatbots', pricing: 'Paid' },
    { name: 'atSpoke', description: 'Now part of Samson. Internal ticketing system.', url: 'https://www.samsonco.com/atspoke', image: 'https://www.google.com/s2/favicons?sz=128&domain=samsonco.com', dataAiHint: 'ticketing system', pricing: 'Paid' },
    { name: 'Talla', description: 'AI-powered knowledge and automation platform.', url: 'https://www.talla.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=talla.com', dataAiHint: 'knowledge platform', pricing: 'Paid' },
    { name: 'Capacity', description: 'AI-powered support automation platform.', url: 'https://capacity.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=capacity.com', dataAiHint: 'support automation', pricing: 'Paid' },
