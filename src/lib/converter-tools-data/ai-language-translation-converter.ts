...
export const aiLanguageTranslationConverterTools: Tool[] = [
    ...
    { name: 'Google Translate', description: 'Instantly translates words, phrases, and web pages.', url: 'https://translate.google.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=google.com', dataAiHint: 'language translation', pricing: 'Free' },
