...
export const aiAudioFormatConverterTools: Tool[] = [
    ...
    { name: 'Switch Audio Converter', description: 'A multi-format audio file converter for Windows and Mac.', url: 'https://www.nch.com.au/switch/index.html', image: 'https://www.google.com/s2/favicons?sz=128&domain=nch.com.au', dataAiHint: 'nch software', pricing: 'Freemium' },
