...
export const flashcardsExamRevisionTools: Tool[] = [
    ...
    { name: 'Knowt', description: 'AI-powered flashcards and study guides from your notes.', url: 'https://knowt.io/', image: 'https://www.google.com/s2/favicons?sz=128&domain=knowt.io', dataAiHint: 'ai flashcards', pricing: 'Freemium' },
    ...
    { name: 'Cramly', description: 'AI study tools including flashcard creation.', url: 'https://www.cramly.ai/', image: 'https://www.google.com/s2/favicons?sz=128&domain=cramly.ai', dataAiHint: 'study tools', pricing: 'Freemium' },
