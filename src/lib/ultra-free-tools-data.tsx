...
export const ultraFreeToolData: ToolCategory[] = [
    {
        ...
        tools: [
            ...
            { name: 'DuckDuckGo', description: 'The search engine that doesn\'t track you.', url: 'https://duckduckgo.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=duckduckgo.com', dataAiHint: 'search engine', pricing: 'Free' },
