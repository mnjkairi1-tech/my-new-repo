...
export const ultraFreeToolData: ToolCategory[] = [
    {
        ...
        tools: [
            ...
            { name: 'Google Gemini', description: 'Google\'s creative and helpful AI collaborator.', url: 'https://gemini.google.com/', image: 'https://picsum.photos/seed/gemini-free/600/400', dataAiHint: 'google ai', pricing: 'Free' },
