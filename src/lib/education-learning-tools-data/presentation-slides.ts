...
export const presentationSlidesTools: Tool[] = [
    ...
    { name: 'Prezi', description: 'Create more engaging, persuasive, and memorable presentations.', url: 'https://prezi.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=prezi.com', dataAiHint: 'conversational presenting', pricing: 'Freemium' },
    ...
    { name: 'Google Slides', description: 'Create and edit presentations online.', url: 'https://www.google.com/slides/about/', image: 'https://www.google.com/s2/favicons?sz=128&domain=google.com', dataAiHint: 'online presentation', pricing: 'Free' },
    { name: 'Microsoft PowerPoint', description: 'The classic presentation software with new AI features.', url: 'https://www.microsoft.com/en-us/microsoft-365/powerpoint', image: 'https://www.google.com/s2/favicons?sz=128&domain=microsoft.com', dataAiHint: 'presentation app', pricing: 'Paid' },
    { name: 'Decktopus', description: 'AI Presentation Maker.', url: 'https://www.decktopus.com/', image: 'https://www.google.com/s2/favicons?sz=128&domain=decktopus.com', dataAiHint: 'ai maker', pricing: 'Paid' },
];
