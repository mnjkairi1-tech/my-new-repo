...
export const videoEditingToolData: ToolCategory[] = [
    ...
    },
    {
        ...
        tools: [
            ...
            { name: 'Descript', description: 'Automatic and human-powered transcription.', url: 'https://www.descript.com/', image: 'https://picsum.photos/seed/descript-subs/600/400', dataAiHint: 'transcription service', pricing: 'Freemium' },
