...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Workflow
} from 'lucide-react';
...
import { type Tool, type ToolCategory, automationWorkflowToolData } from '@/lib/automation-workflow-tools-data';
...
export default function AutomationWorkflowToolsPage() {
    ...
    const filteredToolData = useMemo(() => {
        if (priceFilter === 'All') {
            return automationWorkflowToolData;
        }
