...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Briefcase, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, hrRecruitmentToolData } from '@/lib/hr-recruitment-tools-data';
...
export default function HRRecruitmentToolsPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'HR AI Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'recruitment').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return hrRecruitmentToolData.map(category => {
