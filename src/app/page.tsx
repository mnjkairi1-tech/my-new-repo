      ...
      <div className="my-4">
        ...
        <a href="https://chat.openai.com/" target="_blank" rel="noopener noreferrer">
          <div className="relative cursor-pointer">
            ...
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full w-10 h-10 bg-primary text-primary-foreground glow-shadow flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 gap-4">
          {sortedQuickToolCategories.map((category) => {
            ...
            <Link href={category.url} key={category.name} className="block group">
              <Card className="relative overflow-hidden rounded-2xl soft-shadow transition-all duration-300 group-hover:scale-[1.02]">
                 <Button
                    variant="ghost"
                    size="icon"
                    className={cn(
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
        <header className="px-6 pt-6 flex-shrink-0">
            ...
            <Tabs value={activeTab} onValueChange={(value) => router.push(`/?tab=${value}`)} className="w-full mt-4">
                <TabsList className="grid w-full grid-cols-4 bg-transparent p-0">
                    <TabsTrigger value="home" className="data-[state=active]:border-primary data-[state=active]:text-primary text-base font-semibold border-b-4 border-transparent rounded-none pb-2">{t('tabs.home')}</TabsTrigger>
                    <TabsTrigger value="tools" className="data-[state=active]:border-primary data-[state=active]:text-primary text-base font-semibold border-b-4 border-transparent rounded-none pb-2">{t('tabs.tools')}</TabsTrigger>
                    <TabsTrigger value="trending" className="data-[state=active]:border-primary data-[state=active]:text-primary text-base font-semibold border-b-4 border-transparent rounded-none pb-2">{t('tabs.trending')}</TabsTrigger>
                    <TabsTrigger value="settings" className="data-[state=active]:border-primary data-[state=active]:text-primary text-base font-semibold border-b-4 border-transparent rounded-none pb-2">{t('tabs.settings')}</TabsTrigger>
                </TabsList>
            </Tabs>
        </header>
              ...
              <TabsContent value="trending" className="px-6 mt-4">
                  <div className="space-y-4">
                      <Link href="https://explodingtopics.com/blog/most-popular-ai-tools" target="_blank" className="block group">
                          <Card className="bg-card border-none rounded-2xl soft-shadow overflow-hidden">
