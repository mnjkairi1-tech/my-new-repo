...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Globe, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, websiteBuilderToolData } from '@/lib/website-builder-tools-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Globe className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
