...
import { 
    ArrowLeft, ExternalLink, Star, Share2, FileText as PageIcon, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, invoiceBillingToolData } from '@/lib/invoice-billing-tool-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <PageIcon className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
