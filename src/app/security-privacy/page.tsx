...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Shield, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, securityPrivacyToolData } from '@/lib/security-privacy-tool-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Shield className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
