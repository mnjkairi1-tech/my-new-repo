...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Palette, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, graphicDesignToolData } from '@/lib/graphic-design-tool-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Palette className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
