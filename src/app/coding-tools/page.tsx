...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Code, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, codingToolData } from '@/lib/coding-tools-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Code className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
