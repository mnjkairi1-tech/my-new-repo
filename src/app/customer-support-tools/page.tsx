...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Handshake
} from 'lucide-react';
...
import { type Tool, type ToolCategory, customerSupportToolData } from '@/lib/customer-support-tools-data';
...
export default function CustomerSupportToolsPage() {
    ...
    const filteredToolData = useMemo(() => {
        if (priceFilter === 'All') {
            return customerSupportToolData;
        }
