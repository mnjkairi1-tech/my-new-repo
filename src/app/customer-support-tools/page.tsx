...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Handshake, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, customerSupportToolData } from '@/lib/customer-support-tools-data';
...
export default function CustomerSupportToolsPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'AI Support Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'customer support').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return customerSupportToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Handshake className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
