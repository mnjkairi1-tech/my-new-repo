...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Search, BrainCircuit, Building, FileSearch, Globe, ImageIcon, Video, Mic, Code, GraduationCap, Scale, HeartPulse, Languages, Crosshair, MessageSquare, GitBranch, Clock, ShoppingCart, Newspaper, Wrench, Database, Globe2, HelpCircle, Users, BarChart, Eye, CheckCheck, Shield, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, aiSearchToolData } from '@/lib/ai-search-data';
...
export default function AiSearchPage() {
    ...
    const filteredToolData = useMemo(() => {
        ...
        return aiSearchToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Search className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
