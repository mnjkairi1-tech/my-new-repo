...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, File as FileIcon, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, pdfFileToolData } from '@/lib/pdf-file-tools-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <FileIcon className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
