...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Megaphone, Filter, Search, Bot, Users, Palette, BarChart, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, advertisingToolData } from '@/lib/advertising-tools-data';
...
export default function AdvertisingToolsPage() {
    ...
    const filteredToolData = useMemo(() => {
        ...
        return advertisingToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Megaphone className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
