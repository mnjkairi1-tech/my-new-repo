...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, ListChecks, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, projectManagementToolData } from '@/lib/project-management-tools-data';
...
export default function ProjectManagementToolsPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'Project Management Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'project management').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return projectManagementToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <ListChecks className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
