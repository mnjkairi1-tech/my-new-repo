...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, ListChecks
} from 'lucide-react';
...
import { type Tool, type ToolCategory, projectManagementToolData } from '@/lib/project-management-tools-data';
...
export default function ProjectManagementToolsPage() {
    ...
    const filteredToolData = useMemo(() => {
        if (priceFilter === 'All') {
            return projectManagementToolData;
        }
