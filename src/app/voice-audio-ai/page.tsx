...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Mic, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, voiceAudioAiToolData } from '@/lib/voice-audio-ai-data';
...
export default function VoiceAudioAiToolsPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'Voice AI Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'voice ai').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return voiceAudioAiToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Mic className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
