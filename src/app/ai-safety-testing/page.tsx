...
import { type Tool, aiSafetyTestingToolData } from '@/lib/ai-safety-testing-data';
...
export default function AiSafetyTestingPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'AI Safety Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'ai safety').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return aiSafetyTestingToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <ShieldCheck className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
