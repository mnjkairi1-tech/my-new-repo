...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Zap, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, productivityToolData } from '@/lib/productivity-tool-data';
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'AI Productivity Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'productivity tool').toLowerCase(),
