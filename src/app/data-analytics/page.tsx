...
import { 
    ArrowLeft, ExternalLink, Star, Share2, BarChart3, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, dataAnalyticsToolData } from '@/lib/data-analytics-tool-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <BarChart3 className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
