...
import { 
    ArrowLeft, ExternalLink, Star, Share2, HeartPulse, Filter, X, Plus, Loader2
} from 'lucide-react';
...
export default function HealthcareAiPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'Healthcare AI Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'healthcare').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return healthcareAiToolData.map(category => {
