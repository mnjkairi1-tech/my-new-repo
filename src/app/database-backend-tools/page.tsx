...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Database
} from 'lucide-react';
...
import { type Tool, type ToolCategory, databaseBackendToolData } from '@/lib/database-backend-tools-data';
...
export default function DatabaseBackendToolsPage() {
    ...
    const filteredToolData = useMemo(() => {
        if (priceFilter === 'All') {
            return databaseBackendToolData;
        }
