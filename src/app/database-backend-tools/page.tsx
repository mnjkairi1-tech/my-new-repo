...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Database, X, Plus, Loader2
} from 'lucide-react';
...
export default function DatabaseBackendToolsPage() {
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'Backend Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'database').toLowerCase(),
    ...
    const filteredToolData = useMemo(() => {
        ...
        return databaseBackendToolData.map(category => {
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Database className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
