...
import { 
    ArrowLeft, ExternalLink, Star, Share2, User as UserIcon, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, freelancerToolData } from '@/lib/freelancer-tools-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <UserIcon className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
