...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Filter, Zap
} from 'lucide-react';
...
import { type Tool, type ToolCategory, smartIntegrationsToolData } from '@/lib/smart-integrations-data';
...
export default function SmartIntegrationsPage() {
    ...
    const filteredToolData = useMemo(() => {
        if (priceFilter === 'All') {
            return smartIntegrationsToolData;
        }
