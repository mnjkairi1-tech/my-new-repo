...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Shuffle, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, converterToolData } from '@/lib/converter-tools-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Shuffle className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
