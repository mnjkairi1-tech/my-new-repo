...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Wallet, Filter, X, Plus, Loader2
} from 'lucide-react';
...
import { type Tool, financeAccountingToolData } from '@/lib/finance-accounting-tool-data';
        ...
        <header className="flex items-center justify-between gap-4">
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-2'>
                    <Wallet className={cn("w-6 h-6", isMidnight ? "text-white" : "text-foreground")} />
