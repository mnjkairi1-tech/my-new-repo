...
import { 
    ArrowLeft, ExternalLink, Star, Share2, Feather, Filter, X, Plus, Loader2
} from 'lucide-react';
    ...
    const handleAddTool = async () => {
        ...
        try {
            ...
            const toolData = {
                ...
                description: info.toolDescription || 'AI Writing Tool',
                url: url,
                image: `https://www.google.com/s2/favicons?sz=128&domain=${new URL(url).hostname}`,
                dataAiHint: (info.toolName || 'writing tool').toLowerCase(),
